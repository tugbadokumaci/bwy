...
class HomeCubit extends Cubit<HomeState> {
  ...
  late Resource<List<ServiceModel>> serviceResource;
  ...
  Future<void> getServices() async {
    emit(HomeLoading());
    serviceResource = await _repo.getServices();
    if (serviceResource.status == Status.SUCCESS) {
      emit(HomeSuccess(serviceResource: serviceResource));
